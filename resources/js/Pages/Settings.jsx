...
export default function Settings({ clinic, users = [] }) {
    ...
    const handleClinicUpdate = (e) => {
        e.preventDefault();
        clinicForm.put(route('settings.clinic.update'));
    };
                    ...
                    <form onSubmit={handleClinicUpdate} className="col-span-12 lg:col-span-8 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-8 shadow-sm">
                        ...
                        <div className="flex flex-col md:flex-row gap-10">
                            <div className="flex flex-col items-center gap-4">
                                <div className="h-32 w-32 rounded-xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center border-2 border-dashed border-slate-300 dark:border-slate-700 overflow-hidden relative group">
                                    <img className="w-full h-full object-cover" src="/images/logo.jpg" alt="Clinic Logo" />
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
                        <div className="bg-white dark:bg-slate-900 rounded-2xl w-full max-w-md shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-800">
                            <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center">
                                <h3 className="font-bold text-lg text-primary dark:text-teal-50">Add Team Member</h3>
                            ...
                            <form onSubmit={handleAddUser} className="p-6 space-y-4">
                                <div className="space-y-1">
                                    ...
                                    <input required value={userForm.data.name} onChange={e => userForm.setData('name', e.target.value)} type="text" className="w-full bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-lg text-sm px-4 py-2.5 outline-none focus:ring-2 focus:ring-primary/20 transition-all dark:text-slate-200" placeholder="Dr. John Doe" />
                                ...
                                <div className="space-y-1">
                                    ...
                                    <input required value={userForm.data.email} onChange={e => userForm.setData('email', e.target.value)} type="email" className="w-full bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-lg text-sm px-4 py-2.5 outline-none focus:ring-2 focus:ring-primary/20 transition-all dark:text-slate-200" placeholder="john@catclinic.ph" />
